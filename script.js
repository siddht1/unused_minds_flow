$(document).ready(function () {
  ...
  function between(dir, point, duration, delay, rDelay, easing) {
    ...
    var svg = $(
      "<svg class='pathIt-svg'><path stroke='#fff' fill='none' stroke-width='" +
        strokeW +
        "' d='" +
        d +
        "'/></svg>"
  ...
  function createSvg(dir, point, duration, delay, easing) {
    ...
    var svg = $(
      "<svg data-dir='" +
        dataDir +
        "' class='pathIt-svg'><path stroke='#fff' fill='none' stroke-width='" +
        strokeW +
        "' d='" +
        dTop +
        "'/><path stroke='#fff' fill='none' stroke-width='" +
        strokeW +
        "' d='" +
        dBot +
        "'/></svg>"
